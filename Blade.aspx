    ...
    <table class="table" align="center">
        <tr>
            <td style="height: 7%" colspan="2">
                <img alt="" src="img2/Rec03.png" height="45px" /><br />
                    ...
                    <tr>
                        <td>
                            <table align="center">
                                ...
                                <tr>
                                    <td style="background-image: url(img2/rec01.png); background-size: cover; text-align: center; width: 500px">
                                        <br />
                                            ...
                                            <tr>
                                                <td style="height: 90px">
                                                    <telerik:RadRotator ID="rttBlades" RenderMode="Lightweight" runat="server" RotatorType="ButtonsOver"
                                                        Width="500px" Height="120px" ItemWidth="210px" FrameDuration="1" BorderWidth="0"
                                            ...
                                            <table align="center">
                                                <tr>
                                                    <td style="text-align: center">
                                                        <asp:Image ID="imagePreview" runat="server" ImageUrl="images/spacer.gif" Height="215px"
                                                            Width="400px" AlternateText="preview" BorderWidth="0"></asp:Image>
                                                    </td>
                                                </tr>
                                                <tr>
                                ...
                                <table>
                                        ...
                                        <td>
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><telerik:RadTextBox ID="txbReason" EmptyMessage="Escribe los comentarios" runat="server" Skin="MetroTouch" Width="300px" Visible="True"></telerik:RadTextBox></td>
                                                </tr>
                                            </table>
                                            </div>
                                            <div id="pnlCong">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <asp:ImageButton ID="ImageButton1" runat="server" Width="185px" Height="40px" ImageUrl="img2/btn_Blade02.png" PostBackUrl="~/RequestBlade.aspx" />

...
public partial class Change2 : System.Web.UI.Page
{
    ...
    {
        //if (chbBlades.Checked && txbBlades.Value>0)
        //{
        ...
        if (iRecID != 0)
        {
            ...
            Response.Redirect("ChangeComplete2.aspx");
        }
    }
    protected void chbBlades_CheckedChanged(object sender, EventArgs e)
    {
        //if (chbBlades.Checked)
        //{
        //    txbBlades.Enabled = true;
        //    txbFolios.Enabled = true;
        //    txbBlades.Focus();
        //}
        //else
        //{
        //    txbBlades.Enabled = false;
        //    txbFolios.Enabled = false;
        //}
    }
}
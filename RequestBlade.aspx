                        ...
                        <tr>
                            <td colspan="2" style="text-align: center">
                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                    <ContentTemplate>
                                        <telerik:RadButton RenderMode="Lightweight" Skin="MetroTouch" ID="btnGenerate" runat="server" Enabled="false" Width="278px" Height="61px" OnClick="btnGenerate_Click" CssClass="btnShadow">
